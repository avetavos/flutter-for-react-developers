...
ผลตอบแทนคือ: Dart codebase เดียวที่ ship ไปได้ทั้ง iOS, Android, web, macOS, Windows, และ Linux ด้วย **performance ระดับ native** ทุก platform ไม่มี React Native bridge, ไม่มี Cordova WebView Flutter compile เป็น native ARM code และวาดทุก pixel เองด้วย Impeller graphics engine
