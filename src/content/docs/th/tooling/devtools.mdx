...
export const devtoolsReactDiagram = `flowchart TB
...
export const devtoolsFlutterDiagram = `flowchart TB
...
<Mermaid code={devtoolsReactDiagram} title="React DevTools panels" />
<Mermaid code={devtoolsFlutterDiagram} title="Flutter DevTools panels" />
